...
<br/><br/>
<h1 className="type-eff abt-nf admin-ty" style={{paddingLeft:'1rem',paddingRight:'1rem'}}>Meet the team behind the authentic updates on AgastyaBratha's announcements page</h1>
